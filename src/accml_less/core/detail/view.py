...
from ..interface.view import ViewR as ViewRInterface
from ..interface.view import ViewRW as ViewRWInterface


class View(ViewRWInterface):
    """

    Todo:
        split up if it is read only or readwrite
    """
